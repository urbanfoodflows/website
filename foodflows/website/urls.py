...
urlpatterns = [
    ...
    path("data/imports/", views.importexport_overview, name="imports"),
    path("data/imports/table/", views.importexport, {"page": "table"}, name="imports_table"),
    path("data/imports/barchartgrouped/", views.importexport, {"page": "barchartgrouped"}, name="imports_barchartgrouped"),
    path("data/exports/", views.importexport_overview, {"type": "exports"}, name="exports"),
    path("data/exports/table/", views.importexport, {"page": "table", "type": "exports"}, name="exports_table"),
    path("data/exports/barchartgrouped/", views.importexport, {"page": "barchartgrouped", "type": "exports"}, name="exports_barchartgrouped"),
    ...
    path("contributing/", views.page, {"slug": "contributing"}, name="contributing"),
    path("data/city/<int:id>/", views.data_city, name="data_city"),
    path("data/city/<int:id>/dqi/", views.data_city_dqi, name="data_city_dqi"),
